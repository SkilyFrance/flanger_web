...
class HomeFeedback extends StatefulWidget {
  ...
  @override
  HomeFeedbackState createState() => HomeFeedbackState();
}


class HomeFeedbackState extends State<HomeFeedback> with AutomaticKeepAliveClientMixin {
  @override
          ...
          child: new Column(
            ...
            children: [
             new Padding(
                ...
                child: new Center(
                  child: new Text('Feedback section',
